...
class StudyTrackerApp(ctk.CTk):
    ...
    def build_form_card(self):
        ...
        form_card.grid(row=1, column=0, sticky="ew", padx=24, pady=10)
        ...
        self.note_entry = self._create_labeled_entry(
            form_card, "Note", 3, 0, 4, placeholder="Write a short study note..."
        )
        ...
        add_button.grid(row=2, column=4, columnspan=2, sticky="ew", padx=12, pady=(10, 20))
    ...
    def build_table_card(self):
        ...
        table_card.grid(row=2, column=0, sticky="nsew", padx=24, pady=10)
    ...
    def build_action_bar(self):
        ...
        action_frame.grid(row=3, column=0, sticky="ew", padx=24, pady=(4, 22))
